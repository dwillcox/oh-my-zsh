...
alias bender="ssh -X -o ServerAliveInterval=60 dwillcox@bender.astro.sunysb.edu"
alias groot="ssh -X -o ServerAliveInterval=60 dwillcox@groot.astro.sunysb.edu"

alias sbumerger="ssh -X dwillcox@merger.astro.sunysb.edu"
